   ...
   <div>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="card-block">
            <h2 style="font-size: 30px;text-shadow: -1px -1px orangered;" class="card-title"><a href="<?php echo base_url()?>assets1/img/demopic/frontend.pdf">Web Development</a></h2>
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="card-block">
            <h2 style="font-size: 30px;text-shadow: -1px -1px orangered;" class="card-title"><a href="<?php echo base_url()?>assets1/img/demopic/Java Developer Roadmap.pdf">Java</a></h2>
